...
{
	class NitroExerciseAccessor : NitroExercise
	{
	public:
	...
	TEST_CLASS(NitroExerciseTests)
	{

		/*TEST_METHOD(ValidateReadFile)
		{
			json json;

			NitroExerciseAccessor ne;
			Assert::IsTrue(
				ne.ReadFileAccessor("d:/Users/James/Documents/Visual Studio 2015/Projects/NativeUnitTestNitro/testfile.json", json));
